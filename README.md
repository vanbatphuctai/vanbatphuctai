...
Analyzed ~300K records from AdventureWorks 2019 using SQL in BigQuery (CTEs, window functions, cohort analysis) to evaluate sales growth, territory performance, discounts, inventory, and retention. Delivered insights on 3.87M pending value, 27x stock imbalance, 3.7% early retention, and +389–521% YoY growth, enabling data-driven performance.
...
### [Marketing Performance & Budget Optimization For A Fashion Retail Company | Power BI](https://github.com/vanbatphuctai/Marketing-Performance-Budget-Optimization-For-A-Fashion-Retail-Company-Power-BI)
...
### [Retail Marketing Strategy & RFM Customer Segmentation | Python](https://github.com/vanbatphuctai/Retail-Marketing-Strategy-and-RFM-Customer-Segmentation-Python)
...
- **Power BI:** Data Modeling, DAX, KPI Dashboard Development  
- **Analytics:** Hypothesis Testing, Clustering, RFM Model, Dashboarding
- **Data Tools:** Advanced Excel, Google BigQuery
...
## 📫 Contact
📧 vanbatphuctai@gmail.com  
🔗 LinkedIn: https://www.linkedin.com/in/phuctaivan/
